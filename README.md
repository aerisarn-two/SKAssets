...
```xml
<PackageReference Include="SKAssets" Version="0.1.12" />          <!-- what a plugin names -->
<PackageReference Include="SKAssets.Content" Version="0.1.12" />  <!-- what those files are -->
<PackageReference Include="SKAssets.Export" Version="0.1.12" />   <!-- those files as one scene -->
```
